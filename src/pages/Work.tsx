...
const projects = [
  {
    ...
    description:
      "A comprehensive personal finance management app we built because we needed a better way to manage our finances. Features expense tracking, budget management, and financial insights - all in a beautiful, intuitive interface.",
  ...
  },
  {
    ...
    description:
      "Born from our frustration with bloated, data-hungry office tools. A privacy-first platform offering PDF tools, QR generators, and more - all processing happens locally in your browser. No uploads, no tracking, just tools that work.",
    ...
    links: {
      live: "https://tools.designduck.in",
    },
    type: "own",
  },
  {
    ...
    description:
      "Developed a comprehensive SaaS platform for an international logistics company, including vendor management, tracking systems, and analytics dashboard. Transformed their operations serving thousands of vendors globally.",
  ...
  },
  {
    ...
    description:
      "We're always excited to work on new challenges. Whether you need a complete product build, a platform redesign, or strategic product consulting, we bring the same passion and expertise that we put into our own products.",
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-xl leading-8 text-gray-600 animate-slide-in">
              From our own products born out of personal need to transformative
              client projects, each represents our belief that great products
              emerge when design and engineering work in harmony.
            </p>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <p className="text-lg text-muted-foreground">
              Products we built to solve our own problems, now helping thousands
              of users.
            </p>
          </div>
          ...
          <div className="mb-20">
            ...
            <p className="text-lg text-muted-foreground">
              Transforming businesses through strategic design and development.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-16 lg:gap-20">
            {projects
              .filter((p) => p.type === "client" || p.type === "cta")
              .map((project, index) => (
                <div
                  key={project.title}
                  className={cn(
